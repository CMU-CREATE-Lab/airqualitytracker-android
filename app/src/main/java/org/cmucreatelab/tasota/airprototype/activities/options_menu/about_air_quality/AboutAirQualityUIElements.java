 ...
 */
public class AboutAirQualityUIElements extends UIElements<AboutAirQualityActivity> {
    ...
    public AboutAirQualityUIElements(AboutAirQualityActivity activity) { super(activity); }
